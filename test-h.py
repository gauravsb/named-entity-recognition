...
if __name__ == "__main__":
    ...
    posLines = read_pos_lines("train90.txt")
    train = generateTrainingFeatures(wordLines, posLines, tagLines)
    # print(train)

    #f = open("memm_viterbi_core_features_.pickle", "wb")
    maxent_classifier = MaxentClassifier.train(train, max_iter=8)
    ...
    posPrediction = read_pos_prediction_lines("validation.txt")
